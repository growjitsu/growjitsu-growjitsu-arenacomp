              ...
              <div className="flex -space-x-3">
                {[1,2,3,4].map(i => {
                  ...
                  return (
                    <img 
                      key={i} 
                      src={`https://ui-avatars.com/api/?name=${encodeURIComponent(names[i-1])}&background=0D8ABC&color=fff&size=100`} 
                      className="w-10 h-10 rounded-full border-2 border-[var(--bg-app)]" 
