...
export const PublicHeader: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-20 bg-[var(--header-bg)] backdrop-blur-xl border-b border-[var(--header-border)] flex items-center justify-between px-2 md:px-12 z-50 transition-all duration-500">
      {/* Left: Logo */}
      <div 
      ...
      <form 
        ...
        className="flex-1 max-w-md mx-1 md:mx-12 relative group"
      >
